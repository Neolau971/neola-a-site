...
const text0 = "Les transformations proposés :"
const text1 = "- Type de transformation :"
const text2 = "transformation A"
const text3 = "transformation B"
const text4 = "transformation C"
const text5 = "transformation D"
const text6 = "transformation E"
...
function TransfoVetementsContent() {
  return (
    <div className="AppText">
      <Divider plain><h2 className="AppText">Transformation de vêtement</h2></Divider>
